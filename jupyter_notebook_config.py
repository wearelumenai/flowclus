...
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$oy+d2sFxre96XZhFt6mIeA$mLF9jlcDFy6r79UH8m7jAw'
...
#  Choices: any of ['sha3_384', 'sha3_256', 'sha384', 'sha224', 'sha3_512', 'blake2b', 'blake2s', 'md5', 'sha256', 'sha512', 'sha3_224', 'sha1']
#  Default: 'sha256'
